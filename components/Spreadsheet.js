  ...
  render () {
    return (
      <div className='spreadsheet'>
        ...
        <Table table={this.state.table} onBlur={this.handleBlur} onChange={this.handleChange} onFocus={this.handleFocus} />

        <div className='spreadsheet__focused' >
          {(this.state.focused != null) ? (this.state.focused[0] + " - " + this.state.focused[1]) : null}
        </div>
      </div>
    )
  }
